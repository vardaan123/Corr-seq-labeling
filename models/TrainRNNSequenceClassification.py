""" training script for RNNSequenceClassification
"""
...
__all__ = ["TrainRNNSequenceClassification"]

def TrainRNNSequenceClassification(args,train_data,valid_data):
  """ training function
  """
  ...
  with tf.Graph().as_default():  
    ...
    seq_inputs  = tf.placeholder(tf.int32, shape=(None, args.max_seq_length), name="seq_inputs")
    ...
    logits_op = model.inference(seq_inputs, seq_lengths, 
      ...
      output_dropout_keep_prob = output_dropout_keep_prob, return_logit=True)
...
if __name__ == '__main__':
  ...
  train_data, valid_data, test_data = load_debater_dataset(
    ...
    vocabulary_min_count = args.vocab_min_count,
    mode = args.batch_mode,
    max_sequence_length_context = args.max_seq_length,
    max_sequence_length_sentence = args.max_seq_length,        
  ...
  TrainRNNSequenceClassification(args,train_data,valid_data)
