""" training script for RNNSequenceLabelling
...
__all__ = ["TrainRNNSequenceLabelling"]

def TrainRNNSequenceLabelling(args,train_data,valid_data):
  """ training function
  """
  ...
  # TRAINING
  # ==================================================
  if not bool(args.bidirectional):
...
if __name__ == '__main__':
  ...
  TrainRNNSequenceLabelling(args,train_data,valid_data)
